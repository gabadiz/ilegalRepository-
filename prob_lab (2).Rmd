...
```{r smarthome_iv}
# Vectorizamos la función para que acepte múltiples valores de h
p_h_given_e_vect <- Vectorize(p_h_given_e, vectorize.args = "h")

# Rango de valores posibles de H
h_values <- 0:20  # Suponemos que el máximo posible de H es 20 para este ejemplo

# Calculamos la probabilidad P(H=h | 28 < E < 30) para cada valor de h en h_values
