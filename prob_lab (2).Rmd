...
distribution_empty = function(n_servers, n_datablocks, n_sims){
  ...
  probabilidad = ((prob) / n_sims) # Servidores vacios entre el total de simulaciones
  return(probabilidad)
}
...
plot(as.numeric(names(dist_prob)), as.numeric(dist_prob), type = "h",
     xlab = "Número de servidores vacíos (E)", ylab = "Probabilidad",
